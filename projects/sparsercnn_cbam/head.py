...
class RCNNHead(nn.Module):
    ...
    def forward(self, features, bboxes, pro_features, pooler):
        ...
        pro_features2 = self.self_attn(pro_features, pro_features, value=pro_features)[0]   # attn_output
...
class DynamicConv(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.out_layer = nn.Linear(num_output, self.hidden_dim)  # 展平
    ...
    def forward(self, pro_features, roi_features):
        ...
        parameters = self.dynamic_layer(pro_features).permute(1, 0, 2) # 交换维度
