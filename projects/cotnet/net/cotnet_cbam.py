...
__all__ = [
    ...
    "CoTNet",
    "make_stage",
    "build_cotnet_cbam_backbone",
]

from cotnet.cupy_layers.aggregation_zeropad import LocalConvolution
from cotnet.layers.create_act import get_act_layer
...
class CoTNet(Backbone):
    def __init__(self, stem, stages, num_classes=None, out_features=None):
        ...
        if num_classes is not None:
            ...
            # drawing weights_init from a zero-mean Gaussian with standard deviation of 0.01."
...
def build_cotnet_cbam_backbone(cfg, input_shape):
