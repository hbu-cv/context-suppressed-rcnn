...
from cotnet.net.cotnet import build_cotnet_backbone
from .cotnext import build_cotnext_backbone
from .cotnet_cbam import build_cotnet_cbam_backbone
...
__all__ = ["build_cotnet_fpn_backbone","build_cotnext_fpn_backbone","build_cotnet_cbam_fpn_backbone","FPN"]
...
@BACKBONE_REGISTRY.register()
def build_cotnet_cbam_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
    ...
    Returns:
        backbone (Backbone): backbone module, must be a subclass of :class:`Backbone`.
    """
    bottom_up = build_cotnet_cbam_backbone(cfg, input_shape)
    in_features = cfg.MODEL.FPN.IN_FEATURES
    out_channels = cfg.MODEL.FPN.OUT_CHANNELS
    backbone = FPN(
        bottom_up=bottom_up,
